...
public class LpSolveTest extends TestCase {
	...
	public void testVersion() throws Exception {
		...
		assertEquals(/*0*/2, info.getRelease());
	...
	*/
	...
	public void testReadWriteXLI_CPLEX() throws Exception {
		/* Explicit call */
		SystemX.loadLibrary("xli_CPLEX");
		readWriteXLI("CPLEX");
	}

	public void testReadWriteXLI_LINDO() throws Exception {
		/* Explicit call */
		SystemX.loadLibrary("xli_LINDO");
		readWriteXLI("LINDO");
	}
	...
	*/
	...
	public void testAbortListener() throws Exception {
		...
		MyListener listener = new MyListener(problem);
